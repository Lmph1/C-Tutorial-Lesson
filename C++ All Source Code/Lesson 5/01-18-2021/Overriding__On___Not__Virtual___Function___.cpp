// Runtime Polymorphism: Overriding : Problem With Overriding without virtual function
#include<iostream>
#include<conio.h>
#include<iomanip>
using namespace std;
...
void Demo5()
{
	...
	// Output:
	refB1.Show(1);// Overriding : Late Binding, Dynamic Biding: Problem With Runtime Polymorphism: Need Virtual Function
...
void Demo6()
{
	...
	// Output:
	pB1->Show(1);// Overriding : Late Binding, Dynamic Biding: Problem With Runtime Polymorphism: Need Virtual Function
