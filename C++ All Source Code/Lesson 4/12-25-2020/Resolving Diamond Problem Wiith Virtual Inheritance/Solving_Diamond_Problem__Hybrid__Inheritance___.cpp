// Solving Problem With Hybrid Inheritance 
// Diamond Problem
#include<iostream>
#include<conio.h>
#include<iomanip>
...
//-----------------------------------------------------
//  Virtual Ihheritance
class Homework: virtual public Student  {
	protected:
		double hmark;
	public:
...
//-----------------------------------------------------
//  Virtual Ihheritance
class Assignment: virtual public Student {
	protected:
		double asgmark;
	public:
...
int main()
{
	...
	cout << "\nSize of Class Result : " << sizeof(Result) << " bytes" << endl;//  1byte = 8bits
